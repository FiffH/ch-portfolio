  ...
  return (
    ...
    <Navbar />
      <div className="container landing-container">
          <h1 className="gradient title">CHRIS HARRIS</h1>
          <p className="landing-text">I am a Junior Web Developer based in London.</p>
          <p className="landing-text">I currently specialize in Front End Development and Umbraco CMS.</p>
      </div>
